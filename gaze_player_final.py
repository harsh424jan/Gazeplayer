...
def get_fingers ():
    ...
    ret, img = cap.read()
    cv2.rectangle(img, (250,300), (0,0), (0,255,0),0)
    crop_img = img[0:300, 0:250]
...
while (cap.isOpened()==True or success):
  ...
  if idx%2==0:
    ...
    if count2%5==0:
        ...
        if popup!=0 :
            if finger==3 and play==0:
                pyautogui.click(874,297)
                play=1
            if finger==4 and play==1:
                pyautogui.click(874,297)
                play=0

            if finger==5 and popup==1:
                popup=0
                pyautogui.click(1112,132)
                time.sleep(2)
